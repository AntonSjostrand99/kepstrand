      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {reviews.map((review, index) => (
          <div key={index} className="bg-white border-4 border-black shadow-md rounded-lg p-4 flex flex-col justify-start gap-4">
            <div className="text-center text-lg font-semibold text-gray-800 font-Bungee">{review.name}</div>
            <div className="text-md font-bold text-black font-AmaticSC">{review.text}</div>
